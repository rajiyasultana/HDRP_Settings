...
namespace Studio23.SS2.SettingsManager.Video
{
	...
	public class BrightnessSettings : Settings
	{
		...
		public float MinValue => _minVal;
		public float MaxValue => _maxVal;
		public float CurrentBrightness => CurrentValue.ToFloat();
		...
		{
			CurrentValue = Mathf.Clamp(value, _minVal, _maxVal);
			if(IsLive) Apply();
