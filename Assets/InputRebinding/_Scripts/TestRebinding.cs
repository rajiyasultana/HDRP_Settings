...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputRebinding/_Scripts/TestRebinding.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TestRebinding: IInputActionCollection2, IDisposable
{
    ...
    ~@TestRebinding()
    {
        UnityEngine.Debug.Assert(!m_General.enabled, "This will cause a leak and performance issues, TestRebinding.General.Disable() has not been called.");
    }
